	...
	<div class="container-scroller">
				...
				<ul class="navbar-nav mr-lg-4 w-100">
					...
					<li class="nav-item nav-profile dropdown">
						<a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
							...
							<span class="nav-profile-name">Gudang</span>
						</a>
		...
		<div class="container-fluid page-body-wrapper">
			...
			<nav class="sidebar sidebar-offcanvas" id="sidebar">
				<ul class="nav">
					<li class="nav-item">
						<a class="nav-link" href="<?= base_url('Gudang/cDashboard') ?>">
							<i class="mdi mdi-home menu-icon"></i>
							<span class="menu-title">Dashboard</span>
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="<?= base_url('Gudang/cPermintaan') ?>">
							<i class="mdi mdi-tag menu-icon"></i>
							<span class="menu-title">Permintaan Barang</span>
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="<?= base_url('Gudang/cAnalisis') ?>">
							<i class="mdi mdi-view-headline menu-icon"></i>
							<span class="menu-title">Analisis Barang</span>
						</a>
					</li>
				</ul>
			</nav>
